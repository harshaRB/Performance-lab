...
const styles = {
    ...
    // Animated background orbs - Emerald theme for signup
    orb1: {
        position: 'absolute',
        width: '600px',
        height: '600px',
        ...
        <div style={styles.page}>
            ...
            >
                ...
                <div style={styles.features}>
                    <span style={styles.pill}>🧠 AI Coach</span>
                    <span style={styles.pill}>📊 Analytics</span>
                    <span style={styles.pill}>🎯 Goals</span>
                </div>
